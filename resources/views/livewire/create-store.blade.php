<div>
    ...
    <div class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full flex items-center justify-center">
        <div class="relative bg-white rounded-lg shadow-xl max-w-md mx-auto p-6">
            <h3 class="text-lg font-medium text-gray-900 mb-4">Crear Nueva Tienda</h3>
            ...
            <form wire:submit.prevent="save">
                ...
                <div class="mb-4">
                    ...
                    <input wire:model.live="id" 
                           type="number" 
                           class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('id') border-red-500 @enderror"
                           placeholder="ID (1-100)">
